...
const AppointmentHome = () => {
      ...
      try {
        ...
        if (user) {
          ...
          if (location.state?.patientId) {
            ...
            // Người dùng đặt lịch cho chính họ
            setBookingType('self');
            ...
            // Nhân viên đặt lịch cho bệnh nhân
            setBookingType('staff');
  ...
  useEffect(() => {
    const loadDoctorsAndFees = async () => {
      if (formData.specialty_id) {
        ...
        try {
          // tải giá khám theo specialty_id
  ...
  // Tìm kiếm bệnh nhân cho nhân viên
  ...
  // Chọn bệnh nhân từ kết quả tìm kiếm
  ...
  // Thay đổi input tìm kiếm bệnh nhân
